...
#[bridge_fn(ffi = "privatekey_compressed_edwards_pubkey", node = "PrivateKey_CompressedEdwardsPublicKey")]
fn PrivateKey_CompressedEdwardsPublicKey(key: &PrivateKey) -> Result<PublicKey> {
